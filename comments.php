...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		...
		<nav id="comment-nav-above" class="navigation comment-navigation" role="navigation">
			<h1 class="screen-reader-text"><?php _e( 'Comment navigation', 'kreme' ); ?></h1>
			<div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'kreme' ) ); ?></div>
			<div class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'kreme' ) ); ?></div>
	...
	?>
		<p class="no-comments"><?php _e( 'Comments are closed.', 'kreme' ); ?></p>
	<?php endif; ?>

	<?php comment_form( array(
			'title_reply'          => __( 'Post a comment', 'kreme' ),
			'title_reply_to'       => __( 'Post a comment to %s', 'kreme' ),
			'comment_notes_before' => '',
			'comment_notes_after'  => '',
			'label_submit'         => __( 'Post Comment', 'kreme' ),
